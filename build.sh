...
# mipsel-openwrt-linux-musl-gcc -Os -Wall -static -I codec2/src -I codec2/build_openwrt/src/codec2_native radiotap-library/radiotap.c fec.c wpr_tx_rx.c codec2/build_openwrt/src/libcodec2.a -I "$STAGING_DIR/target-mipsel_24kc_musl/usr/include" -L "$STAGING_DIR/target-mipsel_24kc_musl/usr/lib" -lpcap -o bin/wpr_tx_rx_mips

echo "Building wpr_tx_rx..."
gcc -O0 -fno-omit-frame-pointer -Wall -Wextra -g -Os -Wall radiotap-library/radiotap.c fec.c wpr_tx_rx.c -lcodec2 -lpcap -lm -o bin/wpr_tx_rx
